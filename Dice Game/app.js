   /*If you sort a 1 you lose all your current score.
   If you sort two 6 in a row you lose all your current score.*/
window.addEventListener("load", function() {
    ...
    $rollDiceBtn.addEventListener("click", function() {
      ...
      if(isPlaying) {
        ...
        $dice1.src = "img/die" + randomNumbers[0] + ".png";
        $dice2.src = "img/die" + randomNumbers[1] + ".png";
